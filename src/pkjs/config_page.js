...
'function deleteApiKey() { if (confirm("Delete your OpenRouter API key and conversation memory?")) { document.getElementById("apiKey").value = ""; document.getElementById("apiKeyStatus").style.display = "none"; } }' +
'var memoryResetFlag = false; function resetMemory() { memoryResetFlag = true; alert("Memory reset"); }' +
'function save() { var resetFlag = memoryResetFlag; memoryResetFlag = false; var newSettings = { apiKey: document.getElementById("apiKey").value.trim(), language: document.getElementById("language").value, model: document.getElementById("model").value, customModelId: document.getElementById("customModelId").value.trim(), systemInstruction: document.getElementById("systemInstruction").value.trim(), maxOutputTokens: document.getElementById("maxOutputTokens").value, memoryDepth: document.getElementById("memoryDepth").value, timeoutSeconds: document.getElementById("timeoutSeconds").value, memoryReset: resetFlag }; window.location.href = "pebblejs://close#" + encodeURIComponent(JSON.stringify(newSettings)); }' +
'<\/script>' +
'</body>' +
'</html>';
